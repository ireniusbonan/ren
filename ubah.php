            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="nis" value="<?= $siswa['nis']; ?>" name="nis"
                            readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control w-50" id="tgl_Lahir" value="<?= $siswa['tgl_Lahir']; ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jekel" id="Perempuan" value="Perempuan"
                                <?php if ($siswa['jekel'] == 'Perempuan') { ?> checked='' <?php } ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="Multimedia" <?php if ($siswa['jurusan'] == 'Multimedia') { ?> selected=''
                                <?php } ?>>Multimedia</option>
                            <option value="Rekayasa Perangkat Lunak"
                                <?php if ($siswa['jurusan'] == 'Rekayasa Perangkat Lunak') { ?> selected='' <?php } ?>>
                                Rekayasa Perangkat Lunak</option>
                            <option value="Geomatika" <?php if ($siswa['jurusan'] == 'Geomatika') { ?> selected=''
                                <?php } ?>>Geomatika</option>
                            <option value="Mesin" <?php if ($siswa['jurusan'] == 'Mesin') { ?> selected='' <?php } ?>>
                                Mesin</option>
                        </select>
                    </div>
                    <div class="mb-3">
